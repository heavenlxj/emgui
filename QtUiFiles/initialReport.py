...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.meBandEdit = QtGui.QLineEdit(self.groupBox_2)
        self.meBandEdit.setObjectName(_fromUtf8("meBandEdit"))
        self.gridLayout_2.addWidget(self.meBandEdit, 0, 1, 1, 1)
        ...
        self.meTableWidget.setRowCount(6)
        ...
        item = QtGui.QTableWidgetItem()
        self.meTableWidget.setVerticalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        ...
        item = QtGui.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.meTableWidget.setItem(5, 0, item)
        item = QtGui.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.meTableWidget.setItem(5, 1, item)
        item = QtGui.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.meTableWidget.setItem(5, 2, item)
        item = QtGui.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.meTableWidget.setItem(5, 3, item)
        item = QtGui.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.meTableWidget.setItem(5, 4, item)
        ...
        self.meBandLabel.setBuddy(self.meBandEdit)
        ...
        Form.setTabOrder(self.modelEdit, self.meModelEdit)
        Form.setTabOrder(self.meModelEdit, self.meBandEdit)
        Form.setTabOrder(self.meBandEdit, self.meTableWidget)
        Form.setTabOrder(self.meTableWidget, self.yesRadioBtn)
        Form.setTabOrder(self.yesRadioBtn, self.noRadioBtn)
        Form.setTabOrder(self.noRadioBtn, self.submitButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.telLabel.setText(_translate("Form", "Teplephone Number", None))
        self.taxNumberLabel.setText(_translate("Form", "Fax Number", None))
        self.emailLabel.setText(_translate("Form", "E-mail Address", None))
        self.lbpLabel.setText(_translate("Form", "LBP", None))
        self.shipTypeLabel.setText(_translate("Form", "Ship Type", None))
        self.igtLabel.setText(_translate("Form", "<html><head/><body><p>International Gross Tonnage</p></body></html>", None))
        self.loaLabel.setText(_translate("Form", "LOA", None))
        self.depthMoulded.setText(_translate("Form", "Depth Moulded", None))
        self.intLabel.setText(_translate("Form", "International Net Tonnage", None))
        self.breadthMouldedLabel.setText(_translate("Form", "Breadth Moulded", None))
        self.ecdisMakerLabel.setText(_translate("Form", "ECDIS Maker", None))
        self.modelLabel.setText(_translate("Form", "Model", None))
        ...
        self.meBandLabel.setText(_translate("Form", "M/E Band", None))
        self.meModelLabel.setText(_translate("Form", "M/E Model", None))
        ...
        item = self.meTableWidget.verticalHeaderItem(5)
