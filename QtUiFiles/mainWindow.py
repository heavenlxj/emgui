...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fmrBtn = QtGui.QPushButton(self.frame)
        self.fmrBtn.setObjectName(_fromUtf8("fmrBtn"))
        self.verticalLayout.addWidget(self.fmrBtn)
        self.licenseBtn = QtGui.QPushButton(self.frame)
        self.licenseBtn.setObjectName(_fromUtf8("licenseBtn"))
        self.verticalLayout.addWidget(self.licenseBtn)
        self.quartelyReportBtn = QtGui.QPushButton(self.frame)
        self.quartelyReportBtn.setObjectName(_fromUtf8("quartelyReportBtn"))
        self.verticalLayout.addWidget(self.quartelyReportBtn)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 254, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.quartelyReportBtn.setText(_translate("MainWindow", "Quartely Report", None))
