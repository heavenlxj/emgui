...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.call_signe_edit = QtGui.QLineEdit(self.frame)
        self.call_signe_edit.setEnabled(False)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.call_signe_edit.sizePolicy().hasHeightForWidth())
        self.call_signe_edit.setSizePolicy(sizePolicy)
        self.call_signe_edit.setObjectName(_fromUtf8("call_signe_edit"))
        self.horizontalLayout_3.addWidget(self.call_signe_edit)
        ...
        self.label_callSign.setBuddy(self.call_signe_edit)
        ...
        Form.setTabOrder(self.ship_name_edit, self.call_signe_edit)
        Form.setTabOrder(self.call_signe_edit, self.voyage_number_edit)
        Form.setTabOrder(self.voyage_number_edit, self.use_dw_route_yes_radio)
        Form.setTabOrder(self.use_dw_route_yes_radio, self.use_dw_route_no_radio)
        Form.setTabOrder(self.use_dw_route_no_radio, self.maximum_draft_edit)
