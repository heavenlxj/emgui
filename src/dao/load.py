...
#
# Generated Tue Feb 23 18:54:20 2016 by generateDS.py version 2.18a.
#
# Command line options:
#   ('-f', '')
#   ('-q', '')
#   ('--use-getter-setter', 'none')
#   ('-o', 'D:\\GitRepo\\emgui\\src\\dao\\load.py')
#
# Command line arguments:
#   D:\GitRepo\emgui\src\schema\load.xsd
#
# Command line:
#   C:\Python27\Scripts\generateDS.py -f -q --use-getter-setter="none" -o "D:\GitRepo\emgui\src\dao\load.py" D:\GitRepo\emgui\src\schema\load.xsd
#
...
class Property(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ship_name=None, call_sign=None, voyage_number=None, date=None, voyage_detail=None, via=None, use_dw_route=None, use_critial_point=None, critial_point=None, paper_chart=None, route_number=None, used_times=None, voyage_data=None, total_bunker_consumption=None, average_bunker_consumption_per_nm=None, voyage_performance_efficiency=None, attach_ecdis_route_file=None, attach_emarine_wp_plan=None):
        ...
        self.attach_emarine_wp_plan = attach_emarine_wp_plan
    ...
    def hasContent_(self):
        if (
            ...
            self.used_times is not None or
            ...
            self.attach_emarine_wp_plan is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Property', fromsubclass_=False, pretty_print=True):
        ...
        if self.used_times is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sused_times>%s</%sused_times>%s' % (namespace_, self.gds_format_string(quote_xml(self.used_times).encode(ExternalEncoding), input_name='used_times'), namespace_, eol_))
        ...
        if self.attach_emarine_wp_plan is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sattach_emarine_wp_plan>%s</%sattach_emarine_wp_plan>%s' % (namespace_, self.gds_format_string(quote_xml(self.attach_emarine_wp_plan).encode(ExternalEncoding), input_name='attach_emarine_wp_plan'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'used_times':
            used_times_ = child_.text
            used_times_ = self.gds_validate_string(used_times_, node, 'used_times')
            self.used_times = used_times_
        ...
        elif nodeName_ == 'attach_emarine_wp_plan':
            attach_emarine_wp_plan_ = child_.text
            attach_emarine_wp_plan_ = self.gds_validate_string(attach_emarine_wp_plan_, node, 'attach_emarine_wp_plan')
            self.attach_emarine_wp_plan = attach_emarine_wp_plan_
# end class Property
...
class load_report(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if load_report.subclass:
            return load_report.subclass(*args_, **kwargs_)
        else:
            return load_report(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='load_report', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='load_report')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='load_report', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='load_report'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='load_report', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class voyage_data(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, maximum_draft=None, minimum_ukc=None, load_condition=None, displacement=None, cargo_carried=None, total_distance=None, total_streaming_time=None, average_speed=None, average_slip=None, me_revolution_distance=None, average_me_rmp=None, log_distance=None):
        self.original_tagname_ = None
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from load import *\n\n')
        sys.stdout.write('import load as model_\n\n')
